...
import 'package:flutter_arg_demo/viewmodel/novelcontent_model.dart';
...
class NovelListView extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return new ProviderWidget<NovelContentModel>(
      model: NovelContentModel(),
      onReady: (model) {
        model.getNovelChapter(novel_id);
      },
