...
class VideoModel extends BaseViewModel {
  List<ElBean> elDataList = [];
  ...
  load(bool isRefresh, bool isLoadMore) {
    ...
    notifyListeners();
    Http().get2(Api.GET_VIDEO, content, page, success: (json) {
  ...
  static VideoListBean decode(dynamic json) {
    return VideoListBean.fromJson(json);
  }
}
